...
public class BackgroundWorker extends AsyncTask<String,Void,String> {
    ...
    private String username,movieIdGlobal,movieNameGlobal,personIdGlobal,personNameGlobal;
    ...
    protected String doInBackground(String... params) {
        ...
        if(type.equals("login")){
            //resultString = "login";http://157.44.98.53/samapp/
            username = params[1];
            String password = params[2];
            String login_url = "http://157.44.98.53/samapp/getAns.php";
            ...
            String signup_url = "http://157.44.98.53/samapp/signup.php";
        ...
        else if (type.equals("display_person")){
            resultString += "C";
            String personId = params[1];
            personIdGlobal = personId;
            username = params[2];
            String displayPersonUrl = serverUrl + "display_person.php?mid="+personId;

            try {
                URL url = new URL(displayPersonUrl);
                HttpURLConnection  httpURLConnection = (HttpURLConnection) url.openConnection();
                httpURLConnection.setDoInput(true);
                httpURLConnection.setDoOutput(true);
            ...
            String login_url = "http://157.44.98.53/samapp/post_review.php";
    ...
    private void displaySearchResults(String resultString){
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); ++i) {
                ...
                String imageUrl = "http://157.44.98.53/samapp/img/" + img;
    ...
    private void displayPersonDetails(String resultString){
        LinearLayout linearLayout=((DisplayPersonActivity) context).getLinearLayout();
        String resultStringCopy=resultString;

        int personFrontIndex=resultStringCopy.indexOf('[');
        int personLastIndex=resultStringCopy.indexOf(']');

        String personString =resultStringCopy.substring(personFrontIndex,personLastIndex+1);

        try{
            JSONArray personJsonArray = new JSONArray(personString);
            JSONObject personJsonObject = personJsonArray.getJSONObject(0);

            String first_name = personJsonObject.getString("first_name");
            String country = personJsonObject.getString("country");
            String dob = personJsonObject.getString("dob");
            String gender = personJsonObject.getString("gender");
            String last_name = personJsonObject.getString("last_name");
            String img = personJsonObject.getString("img");
            String imageUrl = "http://157.44.98.53/samapp/img/" + img;
            ...
            addTextView(linearLayout,name,23,5,true);

            //DOB
            addTextView(linearLayout,"date of birth :- "+dob,16,2,true);

            //GENDER
            addTextView(linearLayout,"gender :- "+gender,16,2,true);

            //COUNTRY
            addTextView(linearLayout,"country :- "+country,16,3,true);
    ...
    private void displayMovieDetails(String resultString){
        ...
        try {
            ...
            String imageUrl = "http://1157.44.98.53/samapp/img/" + img;
...
//            REVIEWS
    ...
    protected void onPostExecute(String resultString) {
        ...
        else if (resultString.charAt(0) == 'C') {
            resultString = resultString.substring(1);
            displayPersonDetails(resultString);
        }
